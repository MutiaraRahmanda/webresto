...
<div id="barang" class="container" style="margin-top: 5%;">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="text" class="form-control ins" placeholder="Password..." id="password"><br>
					<input type="text" class="form-control ins" placeholder="Name..." id="checkIn"><br>
					<input type="text" class="form-control ins" placeholder="Phone..." id="checkOut"><br>
					<input type="text" class="form-control ins" placeholder="Address..." id="tables"><br>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<!-- <input type="text" class="form-control ins" placeholder="Password..." id="password"><br>				 -->
					<input type="text" class="form-control ins" placeholder="Name..." id="checkIn1"><br>
					<input type="text" class="form-control ins" placeholder="Phone..." id="checkOut1"><br>
					<input type="text" class="form-control ins" placeholder="Address..." id="tables1"><br>
					<!-- <input type="hidden" id="rowId" val="0"> -->
				</div>
				<div class="modal-footer">
	...
	<div class="panel panel-default them2">
		<div class="panel-heading"><strong><h2>Members</h2></strong></div>
	  		<div class="panel-body">
				<div class="row">
					<div class="col-md-10 col-md-offset-1" align="center">
						<input type="button" class="btn btn-success addRev" value="ADD NEW MEMBER" id="addnew"><br><br><br>
...
<script type="text/javascript">
	...
	function uploadData(data){
		...
		var tables = $('#tables');
		if(cekInsert(member_id) && cekInsert(password) && cekInsert(checkIn) && cekInsert(checkOut) && cekInsert(tables)){
			$.ajax({
				url: 'ajax1.php',
				method: 'POST',
				dataType: 'text',
	...
	function updateRow(update){
		...
		var tables1 = $('#tables1');
		if( cekInsert(member_id1) && cekInsert(checkIn1) && cekInsert(checkOut1) && cekInsert(tables1)){
			$.ajax({
				url: 'ajax1.php',
				method: 'POST',
				dataType: 'text',
